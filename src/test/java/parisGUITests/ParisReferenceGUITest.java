...
//		window = new ParisWork();
	...
	public void testReference() {
		...
		Assert.assertTrue(reference.getBtnOK().isDisposed());
		
	}
	
	@Test
	public void testNoSimultaneousReferences() {
		...
		Reference reference1 = screen0.getReference();
		Assert.assertNotNull(reference1);
		
		list.setSelection(3);
		btn.notifyListeners(SWT.Selection, new Event());
		
		Reference reference2 = screen0.getReference();
		Assert.assertNotNull(reference2);
		
		Assert.assertTrue(reference1.getBtnOK().isDisposed());
		Assert.assertNotSame("Reference windows should be different", reference1, reference2);
		
		Button btnOK = reference2.getBtnOK();
		Assert.assertNotNull(btnOK);
		
		btnOK.notifyListeners(SWT.Selection, new Event());
		Assert.assertTrue(btnOK.isDisposed());

	}
	
	@Test
	public void testReferenceWindowUponScreenChange() {
		...
		// changing screens should dispose reference window also
		TabFolder tabFolder = window.getTabFolder();			
