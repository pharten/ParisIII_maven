...
//	}
	...
	public void testWriteReadFromFile() throws ClassNotFoundException, IOException {
		...
		Assert.assertTrue("systemTemp's are not equal", state1.getSystemTemp().equals(state2.getSystemTemp()));
		Assert.assertTrue("systemPresure's are not equal", state1.getSystemPres().equals(state2.getSystemPres()));
